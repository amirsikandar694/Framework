...
public void loginAsBankManager()
{
	...
	Reporter.log("<a target=\"_blank\" href=\"C:\\EclipseWorkspace\\Banking\\test-output\\error.png\">Screenshot</a>");
// Adding thumbnail in extent reporting	
	Reporter.log("<br>");
	Reporter.log("<a target=\"_blank\" href=\"C:\\EclipseWorkspace\\Banking\\test-output\\error.png\"><img src=\"C:\\EclipseWorkspace\\Banking\\test-output\\error.png\"></img></a>");
